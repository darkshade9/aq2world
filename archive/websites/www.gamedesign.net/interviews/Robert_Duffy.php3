...
<HEAD>
	...
	<META NAME="keywords" CONTENT="interview robert duffy qeradiant map maps level levels making q3radiant">
	<META NAME="description" CONTENT="Interview with Robert Duffy, Programmer of QERadiant">
	<TITLE>Rust - Gamedesign.net Interview with Robert Duffy, Programmer of QERadiant</TITLE>
</HEAD>
			...
			<Table width=200 valign=top>
				...
				<tr>
					<td width=200 bgcolor=#bbbbbb valign=top>
						...
						<a href="http://mappack.gamedesign.net">Omega Development</a><br>
Creating software for the editing community.<br>
Creators of the Mappack series of MODs and Half-Life Menu Maker.						
						</font>
					</td>
				</tr>
			</table>
...
<br><input type=submit value="cast your vote!"></form>
			...
			<Table>
				...
				<tr>
					<td width=200 bgcolor=#bbbbbb valign=top>
						<font face=helvetica size=-1>
						 She sent me a thong in the mail... what am I supposed to do with a thong?						</font>
					</td>
				</tr>
			</table>
			<!--------------------------------------------->
				...
				<tr>
					<Td bgcolor=#555555>
						<font color=white face=helvetica><i><b>
							...
							Interview with Robert Duffy, Programmer of QERadiant
...
<b>What kind of improvements/enhancements can we expect in future
versions of QERadiant/Q3Radiant?
</b>
<br><br>
<blockquote>
The biggest things will be full undo/redo (as opposed to the hacky crap in
there now) and some sort of heiarchial group management. I'm looking into
lighting preview as well as some different ways to use the camera too. New
texturing method of operation, and expanded plugin support/capabilities.
</blockquote><br><br>
<b>Are there any plans for sin or heretic 2 support in the future?</b>
<br><br>
<blockquote>
No on Sin, maybe on Heretic 2. I like both games, well actually I LOVE
Heretic 2 but have just not had time to sit down and go through the
requirements for editing.
</blockquote><br><br>
<b>
Will Q3Radiant be included on the Q3:Arena CD when it ships?
</b>
<br><br>
<blockquote>
I think there is a good possibility but it is really up to the folks at Id.
</blockquote>
<br><br>
<b> 
...
<br><br>
<blockquote>
A newer HL memory friendlier release should be available very soon. Probably
within a few weeks. It may have a few other goodies too.
</blockquote><br><br>
<b>
...
<br><br>
<blockquote>
Never argue with John that it's an engine (and not an editor) bug.. he's
probably right. ;-)
</blockquote
