		  ...
		  <br>						
			...
			<Table>
				...
				<tr>
					<td width=200 bgcolor=#bbbbbb valign=top>
						<font face=helvetica size=-1>
						<b>Team Recycle</b><Br><a href="http://www.gamedesign.net/potd.php3?date=2001-08-02"><img src="http://www.gamedesign.net/potd/pics/small/20010802.jpg"></a><br>This is the final version of my bagman map for Kingpin. I've gotten some good feedback from players on this one. Grab it from here:

http://www.3ddownloads.com/?file_id=150556<br><br><b><a href="mailto:almost@poisonville.com">4LM05T</a></b><br><br><b><small><a href="http://www.gamedesign.net/potd/">submit a pic!</a></small></b><br><small><a href="http://www.gamedesign.net/old_potd.php3">View the POTD Archives</a></small><br>						
						</font>
					</td>
				</tr>
			</table>
...
<br><input type=submit value="cast your vote!"></form>
			...
			<Table>
				...
				<tr>
					<td width=200 bgcolor=#bbbbbb valign=top>
						<font face=helvetica size=-1>
						 Good...  Bad...  I'm the guy with the gun.						</font>
					</td>
				</tr>
			</table>
			<!--------------------------------------------->
					...
					<table width="280" border="0" cellspacing="2" cellpadding="0" valign="TOP">
						...
						<tr>
							<td valign="TOP" bgcolor="#FFFFFF">
								<font face=helvetica size=-1>
								<small>
								<li><a href="http://www.gamedesign.net/news/go_news.php3?id=1671">New Editor: GOOLE</a><br><li><a href="http://www.gamedesign.net/news/go_news.php3?id=1670">Quake 3 Source 1.29h</a><br><li><a href="http://www.gamedesign.net/news/go_news.php3?id=1669">Max Payne Textures Released</a><br><li><a href="http://www.gamedesign.net/news/go_news.php3?id=1665">Unreal-X at PlanetUnreal</a><br><li><a href="http://www.gamedesign.net/news/go_news.php3?id=1664">Max Payne Editing Tutorial</a><br>								</small>
								</font>
							</td>
						</tr>
					</table>
					...
					<table width="280" border="0" cellspacing="2" cellpadding="0" valign="TOP">
						...
						<tr>
							<td valign="TOP" bgcolor="#FFFFFF">
								...
								<li><a href="http://www.gamedesign.net/news/go_news.php3?id=1668">New Forums</a><br><li><a href="http://www.gamedesign.net/news/go_news.php3?id=1667">More News on the Forums</a><br><li><a href="http://www.gamedesign.net/news/go_news.php3?id=1666">Forum Issues</a><br><li><a href="http://www.gamedesign.net/news/go_news.php3?id=1660">Forums</a><br><li><a href="http://www.gamedesign.net/news/go_news.php3?id=1658">Real-Life(tm)</a><br>												
								</small>
								</font>
							</td>
...
<a href="http://www.qeradiant.com"><img src="http://www.gamedesign.net/images/qer_static.gif" width=88 height=31 border=0 alt="We Love QERadiant.com"></a>
    ...
    <Td bgcolor=#555555> <font color=white face=helvetica><i><b> Hosting </b></i></font> 
    </td>
				</tr>
			</table>
			
<blockquote> <font face=helvetica size=-1>We at rust are proud to be offering 
  free webpage hosting on gamedesign.net. <br>
  <br>
  As you know rust deals mainly in the editing aspect of computer games. Therefore 
  we are looking for hosted sites that also deal with the editing side of games. 
  As of now our coverage is mainly the first person shooter style games, but we 
  are looking to change that in the future. That's why we need your help. <br>
  <br>
  Here is what we offer to hosted sites: </font>
  <ul>
    <li><font face="helvetica" size="-1"><b>?????.gamedesign.net domain</b></font></li>
    <li><font face="helvetica" size="-1"><b>pop email account with @gamedesign.net 
      email addresses.</b></font></li>
    <li><font face="helvetica" size="-1"><b>Unlimited Web Space(within reason, 
      not 15 copies of the Kingpin demo)</b></font></li>
    <li><font face="helvetica" size="-1"><b>FTP Space on <a href="http://www.telefragged.com" target="_top">Telefragged's</a> 
      Linux Server</b></font></li>
    <li><font face="helvetica" size="-1"><b>Use of CGI, PHP, PostgreSQL, frontpage 
      extensions(linux)</b></font></li>
    <li><font face="helvetica" size="-1"><b>Log files of traffic</b></font></li>
  </ul>
  <br>
  <br>
  We at rust will also go out of our way to promote your site on the rust front 
  page as well as our host <a href="http://www.telefragged.com" target="_top"><font face="helvetica" size="-1">Telefragged</font></a>. 
  <br>
  <br>
  For hosting inquiries, questions, and comments. <a href="mailto:jherax@gamedesign.net?subject=Hosting">Email 
  us</a> for information or questions.<font face=helvetica size=-1> </font> </blockquote>
