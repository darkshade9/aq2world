...
<title>Clan Pucker Factor - Hit List</title>
</head>
...
<a href="http://www.mapdepot.net"><img src="images/aqmd_gif1.gif" border="0" width="90" height="30"></a>
	...
	<td valign="top" width="440">
			...
			<img src="images/titles/hitlist.gif" border="0" width="216" height="59" alt="[Clan Pucker Factor]"><br>
			</center>
			<hr>
			<p>

			At a clan member's suggestion, we created a hit list of people that have
			rubbed us the wrong way for one reason or another.  Clan members are 
			encouraged to give these people the full <i>Pucker Factor</i> when 
			you see them online.
			<p>
		...
		<tr>
			<td bgcolor="#004444" align="left" valign="top">
				<font face="arial" size="2"><b>Who</b></font>
			</td>
			<td bgcolor="#004444" align="left" valign="top">
				<font face="arial" size="2"><b>Why</b></font>
			</td>
			<td bgcolor="#004444" align="left" valign="top">
				<font face="arial" size="2"><b>Reported By</b></font>
			</td>
			<td bgcolor="#004444" align="left" valign="top">
		...
		<tr>
			<td align="left" valign="top">
				<font face="arial" size="2">Serial Camper</font>
			</td>
			<td align="left" valign="top">
				<font face="arial" size="2">Accused Weasel of cheating & using Zbot.</font>
			</td>
			<td align="left" valign="top">
				<font face="arial" size="2">*CPF* Weasel</font>
			</td>
			<td align="left" valign="top">
				<font face="arial" size="2">Contract Open</font>
			</td>
		</tr>
