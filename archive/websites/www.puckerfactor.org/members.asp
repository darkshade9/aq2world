...
<a href="http://www.mapdepot.net"><img src="images/aqmd_gif1.gif" border="0" width="90" height="30"></a>
		...
		<td valign="top" width="440">
			...
			<center><img src="images/titles/members.gif" width="241" height="61" alt="[Members]"></center>
...
<!--	
				...
				<a href="#AcetonE">[*CPF* AcetonE]</a>&nbsp;
			
				<a href="#Angel">[*CPF* Angel]</a>&nbsp;
			
				<a href="#Buffy">[*CPF* Buffy]</a>&nbsp;
			
				<a href="#illcutyourass">[*CPF* illcutyourass]</a>&nbsp;
			
				<a href="#PunctureWound">[*CPF* Puncture Wound]</a>&nbsp;
			
				<a href="#RichyRich">[*CPF* Richy Rich]</a>&nbsp;
			
				<a href="#SoulCrusher">[*CPF* Soul Crusher]</a>&nbsp;
			
				<a href="#Weasel">[*CPF* Weasel]</a>&nbsp;
...
-->
			...
			<table cellspacing="0" cellpadding="0" border="0">
				...
				<tr>
					<td background="images/fill1.gif">
					...
					<td background="images/gradient2.gif" width="30">&nbsp;</td>
		
					<td>
						<font face="arial" size="3">
						<b>
						&nbsp;<a href="member_detail.asp?handle=%2ACPF%2A+AcetonE">AcetonE</a>
					</td>
				</tr>
			...
			<table cellspacing="0" cellpadding="0" border="0">
				...
				<tr>
					...
					<td>
						<font face="arial" size="3">
						<b>
						&nbsp;<a href="member_detail.asp?handle=%2ACPF%2A+Angel">Angel</a>
					</td>
				</tr>
			...
			<table cellspacing="0" cellpadding="0" border="0">
				...
				<tr>
					...
					<td>
						<font face="arial" size="3">
						<b>
						&nbsp;<a href="member_detail.asp?handle=%2ACPF%2A+Buffy">Buffy</a>
					</td>
				</tr>
			...
			<table cellspacing="0" cellpadding="0" border="0">
				...
				<tr>
					...
					<td>
						<font face="arial" size="3">
						<b>
						&nbsp;<a href="member_detail.asp?handle=%2ACPF%2A+illcutyourass">illcutyourass</a>
					</td>
				</tr>
			...
			<table cellspacing="0" cellpadding="0" border="0">
				...
				<tr>
					...
					<td>
						<font face="arial" size="3">
						<b>
						&nbsp;<a href="member_detail.asp?handle=%2ACPF%2A+Puncture+Wound">Puncture Wound</a>
					</td>
				</tr>
			...
			<table cellspacing="0" cellpadding="0" border="0">
				...
				<tr>
					...
					<td>
						<font face="arial" size="3">
						<b>
						&nbsp;<a href="member_detail.asp?handle=%2ACPF%2A+Richy+Rich">Richy Rich</a>
					</td>
				</tr>
			...
			<table cellspacing="0" cellpadding="0" border="0">
				...
				<tr>
					...
					<td>
						<font face="arial" size="3">
						<b>
						&nbsp;<a href="member_detail.asp?handle=%2ACPF%2A+Soul+Crusher">Soul Crusher</a>
					</td>
				</tr>
			...
			<table cellspacing="0" cellpadding="0" border="0">
				...
				<tr>
					...
					<td>
						<font face="arial" size="3">
						<b>
						&nbsp;<a href="member_detail.asp?handle=%2ACPF%2A+Weasel">Weasel</a>
					</td>
				</tr>
